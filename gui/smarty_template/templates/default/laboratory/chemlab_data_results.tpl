				...
				<form method="post" {{$sFormAction}} onSubmit="return pruf(this)" name="datain">
					...
					<tbody>
						...
						<tr>
							...
							<td class="adm_input">{{$sCollectionDate}} {{$sMiniCalendar}}</td>
						</tr>
						<tr>
							<td class="adm_item">Received Date:</td>
							<td class="adm_input">{{$sReceivedDate}} {{$sMiniCalendar}}</td>
						</tr>
						<tr>
							<td class="adm_item">Report Date:</td>
							<td class="adm_input">{{$sReportDate}} {{$sMiniCalendar}}</td>
						</tr>
						<tr>
							<td class="adm_item">Clinical History:</td>
							<td class="adm_input">{{$sHistory}}</td>
						</tr>
						<tr>
							<td class="adm_item">Comments:</td>
							<td class="adm_input">{{$sComments}}</td>
						</tr>
					</tbody>
					</table>
