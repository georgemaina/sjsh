...
{{* This template is used by /modules/nursing/nursing_station.php to populate the ward_occupancy_list.tpl template *}}
 ...
 {{/if}}
		...
		<td>&nbsp;{{$sAdmitDataIcon}} {{$sChartFolderIcon}} {{$sNotesIcon}} {{$sInvoiceIcon}} {{$sNursesNotesIcon}}
			{{$sNursesNotesIcon}} {{$sNursesNotesIcon}} {{$sNursesNotesIcon}} {{$sNursesNotesIcon}} {{$sVitalsIcon}} {{$sTransferIcon}} {{$sDischargeIcon}}</td>
		</tr>
		<tr>
