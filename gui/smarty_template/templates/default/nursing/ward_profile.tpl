...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td class="adm_input" colspan="3"><textarea name="description" cols=40 rows=8 wrap="physical">{{$description}}</textarea></td>
      <!--<td class="adm_input" colspan="2">{{$description}}</td>-->
    </tr>
    <tr>
      <td class="adm_item">{{$LDRoom1Nr}}</td>
      <td class="adm_input" colspan="3"><textarea name="room_nr_start" cols=4 rows=1 wrap="physical">{{$room_nr_start}}</textarea></td>
      <!--<td class="adm_input" colspan="2">{{$room_nr_start}}</td>-->
    </tr>
    <tr>
      <td class="adm_item">{{$LDRoom2Nr}}</td>
      <td class="adm_input" colspan="3"><textarea name="room_nr_end" cols=4 rows=1 wrap="physical">{{$room_nr_end}}</textarea></td>
      <!--<td class="adm_input" colspan="2">{{$room_nr_end}}</td>-->
    </tr>
    <tr>
      <td class="adm_item">{{$LDRoomPrefix}}</td>
      <td class="adm_input" colspan="3"><textarea name="roomprefix" cols=4 rows=1 wrap="physical">{{$roomprefix}}</textarea></td>
  ...
  {{if $bShowRooms}}
   ...
   <tr  class="wardlisttitlerow">
      ...
      <td>{{$LDRoomCharge}}</td>
      <td>{{$LDNursingCharge}}</td>
      <td>{{$LDDoctorsCharge}}</td>
       <td>{{$LDAccomCharge}}</td>
    </tr>
