<?php /* Smarty version 2.6.22, created on 2016-07-21 23:55:18
...
" name="aufnahmeform" onSubmit="return chkform(this)">
 ...
 align="center" class="photo_id">
						<?php echo $this->_tpl_vars['img_source']; ?>
                                ...
                                <tr>
					<td  class="adm_item">
						<?php echo $this->_tpl_vars['LDNewAdmNo']; ?>
:
					</td>
					<td class="adm_input">
						<?php echo $this->_tpl_vars['newAdm_No']; ?>
...
:
					...
					<td colspan=2 class="adm_input">
						<?php echo $this->_tpl_vars['consultation_fee']; ?>
                                ...
                                <tr>
					<td class="adm_item">
						<?php echo $this->_tpl_vars['LDFinanceClass']; ?>
:
					</td>
					<td colspan=2 class="adm_input">
						<?php echo $this->_tpl_vars['finance_class']; ?>
            ...
            <tr>
                <td class="adm_item">
                    <?php echo $this->_tpl_vars['LDReferals']; ?>
:
                </td>
                <td colspan=2 class="adm_input">
                    <?php echo $this->_tpl_vars['referals']; ?>
