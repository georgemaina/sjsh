<?php /* Smarty version 2.6.22, created on 2016-10-05 12:59:52
...
<table>
  <tbody>
    <tr>
      ...
      <td class="adm_input" colspan="3"><?php echo $this->_tpl_vars['name']; ?>
</td>
    </tr>
    <tr>
      ...
      <td class="adm_input" colspan="3"><?php echo $this->_tpl_vars['ward_id']; ?>
</td>
    </tr>
    <tr>
      <td class="adm_item"><?php echo $this->_tpl_vars['LDDept']; ?>
</td>
      <td class="adm_input" colspan="3"><?php echo $this->_tpl_vars['dept_name']; ?>
</td>
    </tr>
    <tr>
      <td class="adm_item"><?php echo $this->_tpl_vars['LDDescription']; ?>
</td>
      <td class="adm_input" colspan="3"><textarea name="description" cols=40 rows=8 wrap="physical"><?php echo $this->_tpl_vars['description']; ?>
</textarea></td>
    ...
    <tr>
      ...
      <td class="adm_input" colspan="3"><textarea name="room_nr_start" cols=4 rows=1 wrap="physical"><?php echo $this->_tpl_vars['room_nr_start']; ?>
</textarea></td>
    ...
    <tr>
      ...
      <td class="adm_input" colspan="3"><textarea name="room_nr_end" cols=4 rows=1 wrap="physical"><?php echo $this->_tpl_vars['room_nr_end']; ?>
</textarea></td>
    ...
    <tr>
      ...
      <td class="adm_input" colspan="3"><textarea name="roomprefix" cols=4 rows=1 wrap="physical"><?php echo $this->_tpl_vars['roomprefix']; ?>
</textarea></td>
   ...
   <tr>
      ...
      <td class="adm_input" colspan="3"><?php echo $this->_tpl_vars['date_create']; ?>
</td>
    </tr>
   <tr>
      <td class="adm_item"><?php echo $this->_tpl_vars['LDCreatedBy']; ?>
</td>
      <td class="adm_input" colspan="3"><?php echo $this->_tpl_vars['create_id']; ?>
</td>
    </tr>

  <?php if ($this->_tpl_vars['bShowRooms']): ?>
   <tr>
      <td class="adm_item" colspan="9">&nbsp;</td>
    </tr>
   <tr  class="wardlisttitlerow">
      <td><?php echo $this->_tpl_vars['LDRoom']; ?>
       ...
       <td><?php echo $this->_tpl_vars['LDFirstBedNo']; ?>
</td>
       <td><?php echo $this->_tpl_vars['LDLastBedNo']; ?>
</td>
      <td><?php echo $this->_tpl_vars['LDRoomShortDescription']; ?>
</td>
      <td><?php echo $this->_tpl_vars['LDRoomCharge']; ?>
</td>
      <td><?php echo $this->_tpl_vars['LDNursingCharge']; ?>
</td>
      <td><?php echo $this->_tpl_vars['LDDoctorsCharge']; ?>
</td>
       <td><?php echo $this->_tpl_vars['LDAccomCharge']; ?>
</td>
    </tr>
