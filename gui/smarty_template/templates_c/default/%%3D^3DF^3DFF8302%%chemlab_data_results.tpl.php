<?php /* Smarty version 2.6.22, created on 2018-10-12 11:38:09
...
:</td>
 ...
 <?php echo $this->_tpl_vars['sMiniCalendar']; ?>
						...
						<tr>
							<td class="adm_item">Collection Date:</td>
							<td class="adm_input"><?php echo $this->_tpl_vars['sCollectionDate']; ?>
 <?php echo $this->_tpl_vars['sMiniCalendar']; ?>
</td>
						</tr>
						<tr>
							<td class="adm_item">Received Date:</td>
							<td class="adm_input"><?php echo $this->_tpl_vars['sReceivedDate']; ?>
 <?php echo $this->_tpl_vars['sMiniCalendar']; ?>
</td>
						</tr>
						<tr>
							<td class="adm_item">Report Date:</td>
							<td class="adm_input"><?php echo $this->_tpl_vars['sReportDate']; ?>
 <?php echo $this->_tpl_vars['sMiniCalendar']; ?>
</td>
						</tr>
						<tr>
							<td class="adm_item">Clinical History:</td>
							<td class="adm_input"><?php echo $this->_tpl_vars['sHistory']; ?>
</td>
						</tr>
						<tr>
							<td class="adm_item">Comments:</td>
							<td class="adm_input"><?php echo $this->_tpl_vars['sComments']; ?>
</td>
						</tr>
					</tbody>
					</table>
