...
if(!$_SESSION['sess_user_name']) $_SESSION['sess_user_name'];
if(!$_SESSION['sess_user_origin']) $_SESSION['sess_user_origin'];
if(!$_SESSION['sess_file_forward']) $_SESSION['sess_file_forward'];
if(!$_SESSION['sess_file_return']) $_SESSION['sess_file_return'];
if(!$_SESSION['sess_file_break']) $_SESSION['sess_file_break'];
if(!$_SESSION['sess_path_referer']) $_SESSION['sess_path_referer'];
if(!$_SESSION['sess_dept_nr']) $_SESSION['sess_dept_nr'];
if(!$_SESSION['sess_title']) $_SESSION['sess_title'];
if(!$_SESSION['sess_lang']) $_SESSION['sess_lang'];
if(!$_SESSION['sess_user_id']) $_SESSION['sess_user_id'];
if(!$_SESSION['sess_cur_page']) $_SESSION['sess_cur_page'];
if(!$_SESSION['sess_searchkey']) $_SESSION['sess_searchkey'];
if(!$_SESSION['sess_tos']) $_SESSION['sess_tos']; # the session time out start time
if(!$_SESSION['sess_shift']) $_SESSION['sess_shift'];
if(!$_SESSION['sess_accountingdb']) $_SESSION['sess_accountingdb'];
if(!$_SESSION['sess_pharmloc']) $_SESSION['sess_pharmloc'];
...
$glob_cfg->getConfig('AccountingDB');
$glob_cfg->getConfig('PharmacyStoreLocation');
...
if(empty($_SESSION['sess_accountingdb'])) $_SESSION['sess_accountingdb']=$GLOBALCONFIG['AccountingDB'];
if(empty($_SESSION['sess_pharmloc'])) $_SESSION['sess_pharmloc']=$GLOBALCONFIG['PharmacyStoreLocation'];
