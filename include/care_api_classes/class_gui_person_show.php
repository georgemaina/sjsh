...
//				$insurance_class_info=$pinsure_obj->getInsuranceClassInfo($insurance_class_nr);
		...
		$this->smarty->assign('sRegDate',@formatDate2Local($date_reg,$date_format,TRUE,FALSE,'-').'<input name="date_reg" type="hidden" value="'.$date_reg.'"');
		...
		$this->smarty->assign('sBdayInput','<div class="vi_data">'.@formatDate2Local($date_birth,$date_format,FALSE,FALSE,'-').'</div>');
        ...
        $this->smarty->assign('LDnextkin',"$LDnextkin :");
        $this->smarty->assign('sNextOfKin',$next_of_kin);

        $this->smarty->assign('LDnextkin2',"$LDnextkin :");
        $this->smarty->assign('sNextOfKin2',$next_of_kin2);
