            ...
            function createInvoiceTitle($pid, $encNo,$pnames,$ward,$dept,$dob,$sex,$admDate,$disDate,$encounterClass){
                ...
                echo "<div class='page'>";
                 echo "<div class='subpage'>
                        <table border=0>
                            ...
                            <tr>
                                <td colspan='6' class='summaryTitle'>DOCTORS NOTES</td>
                            </tr>";
                ...
                $sql="SELECT `date`,`time`,notes,n.`create_id`,u.`designation` FROM care_encounter_notes n 
                                LEFT JOIN care_users u ON n.`create_id`=u.`name`
                                 WHERE encounter_nr=$encNo AND u.`designation` IN('DOCTOR','CO')";
                                 //echo $sql;
                     $result=$db->Execute($sql);

                      echo "<tr><td colspan='7'><hr></td></tr>";
                     echo "<tr><td colspan='7' class='invTitle'>DOCTORS NOTES</td></tr>";
