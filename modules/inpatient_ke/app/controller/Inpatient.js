 ...
 * Date: Fri Mar 13 2020 12:24:15 GMT+0300 (E. Africa Standard Time)
 *
...
Ext.define('Inpatient.controller.Inpatient', {
        ...
        Ext.Ajax.request({
            ...
            success: function(response){
               ...
               //  Ext.ComponentQuery.query("#pname")[0].setValue(pnames);
                ...
                this.getDebit().down('#debitDate').setValue(encDetails.encounterNr[0].CurrDate);
    ...
    getDebitNo: function() {
        Ext.Ajax.request({
            url: '../../data/getDataFunctions.php?task=getDebitNo',
    ...
    assignBed: function(view, rowIndex, colIndex, item, e, record, row) {
        if(record.get('Pid')===''){
            let pid=view.up('grid').down('#pid').getValue();
            let encNo=view.up('grid').down('#encounterNo').getValue();
            let str=record.get('RoomNo');
            let room=str.split(" ");
            let ward_nr=view.up('grid').down('#wardno').getValue();
            let bed=record.get('BedNo');
    ...
    openNotes: function(view, rowIndex, colIndex, item, e, record, row) {
            ...
            this.getPatientdetails().down('#wardno').setValue(record.get('Ward'));
    ...
    printInvoices: function(button) {
        ...
        var urlholder="reports/patientInvoice.php?pid="+pid+"&billNumber="+bill_number+"&receipt=1";
