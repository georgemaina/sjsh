 ...
 * Date: Tue Jul 28 2020 15:35:49 GMT+0300 (E. Africa Standard Time)
 *
...
Ext.define('Inpatient.controller.Navigation', {
    ...
    navigate: function(id) {
        ...
        if (id) {
            ...
            var panelItem=Ext.create("Inaptient.view."+id,{});
            var centerContainer=this.getMainpanel().down("container[region=center]");
            centerContainer.removeAll();
            centerContainer.add(panelItem);
