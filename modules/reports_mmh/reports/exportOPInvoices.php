...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', 'Account Number');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A2', 'pid');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B2', 'Encounter Number' );
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F2', 'Amount' );
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G2', 'Payment Method' );
...
while($row=$result->FetchRow()){
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue("G$i",$row['PaymentMethod']);
    $objPHPExcel->getActiveSheet()->getColumnDimension('G')->setWidth(10);
