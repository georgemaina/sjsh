...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('N2', 'PAYMENT MODE' );
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O2', 'NHIF CREDIT' );
...
while($row=$result->FetchRow()){
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue("N$i", $paymode);
    $objPHPExcel->getActiveSheet()->getColumnDimension('N')->setWidth(15);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue("O$i", $NHIF);
