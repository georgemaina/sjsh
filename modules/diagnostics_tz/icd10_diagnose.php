...
if($todo=='submit')
{
    ...
    $status="Patients Diagnosis Updated in the Doctors room";
    $statusDesc="Patients Diagnosis Updated in the Doctors room";
    $bill_obj->updatePatientStatus($_SESSION['sess_full_en'],$_SESSION['sess_full_en'],$statusType,$status,$statusDesc,$currUser);
