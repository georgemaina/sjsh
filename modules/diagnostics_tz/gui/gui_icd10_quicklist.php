...
(<?php echo $_SESSION['sess_pid']; ?>)</font></td>
	  	<td align="right"><a href="<?php echo $_SESSION['backpath_diag'];?>">
                <img src="../../gui/img/control/default/en/en_back2.gif" border=0 width="110" height="24" alt="" style="filter:alpha(opacity=70)"></a>
            <?php if($_SESSION['ispopup']=="true")
	  	...
	  	<a href="<?php echo $_SESSION['backpath_diag'];?>"><img src="../../gui/img/control/default/en/en_close2.gif" border=0 width="103" height="24" alt="" style="filter:alpha(opacity=70)"></a>
	  	</td>
	  </tr>
  </table>
    </td>
  ...
  <tr>
    <td><form name="icd10" method="post" action="icd10_diagnose.php<?php echo URL_APPEND; ?>">
            <?php
                 if($encounterClass==2){
                     $quickButton="<input type='button' name='show' value='$LDQuicklist' onClick='javascript:submit_form(this,'icd10_quicklist.php','$sid','')>";
                 }elseif($encounterClass==1){
                     $searchButton="<input type='button' name='show' value='$LDSearch' onClick='javascript:submit_form(this,'icd10_search.php','$sid','')>";
                }else{
                     $quickButton="";
                     $searchButton="";
                 }
	...
	<table width="100%" border="0">
	  <tr>
          <td width='25%' bgcolor='#CAD3EC'>
              <div align='center'><?php echo $quickButton; ?></div>
          <td width='17%' class='adm_input'>
              <div align='center'><?php echo $searchButton; ?></div
          </td>
		<td width="20%" class="adm_input">
            <div align="center"><input type="button" name="show" value="<?php echo $LDHistory; ?>" onClick="javascript:submit_form(this,'icd10_history.php','<?php echo $sid ?>','')"></div>
        </td>
		<td width="38%" class="adm_input">
            <div align="center"><input type="button" name="show" value="<?php echo $LDManageQuicklist; ?>" onClick="javascript:submit_form(this,'icd10_manage.php','<?php echo $sid ?>','')"></div>
        </td>
	  </tr>
	</table>
