...
case 'sqldb': $title=$LDSqlDb;
	...
	case 'modulgenerator':	$title=$LDSystemLogin;
            ...
            break;
    case 'catalog':	$title=$LDSystemLogin;
            //$userck='ck_edv_admin_user';
//            $allowedarea=$allow_area['stockmaster'];
            $fileforward=$root_path."modules/ProductCatalog/index.html'";
            break;
    case 'inpatient':$title=$LDSystemLogin;
            //$userck='ck_edv_admin_user';
//            $allowedarea=$allow_area['billing'];
            $fileforward=$root_path."modules/inpatient_ke/index.html";
            break;
