...
$aSubMenuItem=array('LDQViewTxt' => '<a href="edv-main-pass.php'.URL_APPEND.'&target=adminlogin">'.$LDManageAccess.'</a>',
    ...
    'LDProductCategoryTxt' => '<a href="'.$root_path.'modules/ProductCatalog/index.php'.URL_APPEND.'&target=catalog">'.$LDProductCatalog.'</a>',
    'LDInpatientTxt' => '<a href="'.$root_path.'modules/inpatient_ke/index.php'.URL_APPEND.'&target=inpatient">'.$LDInpatientKe.'</a>');
