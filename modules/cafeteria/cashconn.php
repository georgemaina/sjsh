...
//    $new_bill_number=$bill_obj->checkBillEncounter($encounter_nr);
    ...
    '$Prec_Desc','$amount','$proc_qty','$total','$username','Receipt Payment','Paid','$batch_no','".date('H:m:s')."','$revcode','$Proc_code','$Proc_code')";
...
function updateCashErp($db,$pn,$ref_no) {
      ...
      $debug=false;;
        ...
        $sql='SELECT patient,`name`,input_date,SUM(total) AS mytotal,ref_no,input_date,rev_code as partcode,"rct" as ledger 
