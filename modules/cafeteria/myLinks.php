...
function displayReceipt($cash_point,$refno,$cashier,$paymode,$payer,$chequeNo,$patientid,$patientname,$total,$rtext) {
    ?>
<script>
...
function getBalance(str){
    ...
    <?php
    function displayReceipts($rdate,$refno,$cashier,$pno,$PatientName,$PaymentMode,$cashpoint,$payer,$reprint) {
    ?>
<script>
    window.open('http://localhost/receipt/index.php?rdate=<?php echo $rdate ?>&refno=<?php echo $refno ?>&cashier=<?php echo $cashier ?>&pno=<?php echo $pno ?>\n\
&PatientName=<?php echo $PatientName ?>&PaymentMode=<?php echo $PaymentMode ?>&cashpoint=<?php echo $cashpoint ?>&payer =<?php echo $payer ?>&reprint =<?php echo $reprint ?>'
    ,"receipt","menubar=no,toolbar=no,width=300,height=550,location=yes,resizable=no,scrollbars=no,status=yes");
...
<?php
  ...
  function displayGLReceipts($rdate,$refno,$cashier,$pno,$PatientName,$PaymentMode,$cashpoint,$payer,$reprint) {
    ?>
<script>
