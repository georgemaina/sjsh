...
?>
 <script>
            ...
            revgrid.setHeader("code,description,more_info,price");
            revgrid.attachHeader("#connector_text_filter,#connector_text_filter")
            revgrid.setInitWidths("50,150,150,100");
            revgrid.setSkin("light");
            revgrid.setColSorting("str,str,str,int");
            revgrid.setColTypes("ed,ed,ed,ed");
            revgrid.enableSmartRendering(true);
            revgrid.enableMultiselect(true);
            revgrid.init();
            revgrid.loadXML("revenueconn.php")

           var revDP=new dataProcessor("revenueconn.php");
            revDP.init(revgrid);
