...
<script> //display datagrid
    ...
    sgrid.setHeader("catID,item_Cat,amount,qty,total");
    sgrid.setInitWidths("80,180,80,180,100,50,100");
    sgrid.setSkin("light");
    sgrid.setColTypes("ed,ro,ed,ed,ed");
...
<tr><td align="left" colspan="6">
        ...
        <button onclick=initRevPop()>Get Revenue Item</button>
