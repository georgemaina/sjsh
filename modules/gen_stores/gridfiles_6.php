<script>
    ...
    sgrid.setHeader("code,Description,Price");
    sgrid.attachHeader("#connector_text_filter,#connector_text_filter")
    sgrid.setInitWidths("80,300,80");
    sgrid.setSkin("light");
    sgrid.setColTypes("ro,ro,ro");
    sgrid.setColSorting("str,str,int");
    sgrid.setColumnColor("white,white,white");
    sgrid.loadXML("priceConn.php");
