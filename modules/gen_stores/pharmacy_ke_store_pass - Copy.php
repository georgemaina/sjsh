...
if($target=='serv'){
    $allowedarea=&$allow_area['genService'];
    $fileforward="pharmacy_ke_service_order.php?sid=".$sid."&lang=".$lang;
}else if($target=='order'){
    $allowedarea=&$allow_area['genOrder'];
    $fileforward="pharmacy_ke_show_order.php?sid=".$sid."&lang=".$lang;
}else if($target=='return'){
    $allowedarea=&$allow_area['genReturn'];
    $fileforward="pharmacy_ke_show_return.php?sid=".$sid."&lang=".$lang;
//}else if($target=='levels'){
//    $allowedarea=&$allow_area['genLevels'];
//    $fileforward="pharmacy_ke_show_levels.php?sid=".$sid."&lang=".$lang;
}else if($target=='reports'){
    $allowedarea=&$allow_area['genReports'];
    $fileforward="pharmacy_ke_show_Reports.php?sid=".$sid."&lang=".$lang;
}
