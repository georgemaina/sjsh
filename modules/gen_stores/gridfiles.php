<script>
    ...
    sgrid.setHeader("Item_ID,Description,Qty_in_store,price,Qty_to_order");
    sgrid.setInitWidths("80,200,120,120,120");
    sgrid.setSkin("light");
    sgrid.setColTypes("ro,ro,ro,ed,ed");
   // sgrid.setColValidators("NotEmpty,NotEmpty,NotEmpty,NotEmpty,NotEmpty");
    sgrid.setColSorting("str,str,str,int,int");
...
var dhxWins, w1, grid;
   ...
   function doOnCellEdit(stage,rowId,cellInd){
        ...
        if(stage==2 && cellInd==4){
            ...
            document.getElementById('totalOrders').value='total' +sumColumn(4);
...
function initPSearch(){
        ...
        store=document.getElementById('storeID').value;
