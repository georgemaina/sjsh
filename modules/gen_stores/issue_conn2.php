...
global $db;
    ...
    $sql = "SELECT a.nr,b.encounter_nr,b.encounter_class_nr,a.prescribe_date,a.partcode,b.pid,a.article_item_number,a.article,
            ...
            WHERE b.pid='".$pid."' AND a.drug_class in ('drug_list','Medical-Supplies') and b.encounter_class_nr=1 AND a.status
