...
<TR>
	<td align=center><img src="../../gui/img/common/default/settings_tree.gif" border=0 width="16" height="17"></td>
	<TD class="submenu_item"><nobr><a href="pharmacy_tz_priceUpdate.php"><?php echo $LDUpdateWeberpPrice; ?></a></nobr></TD>

	<TD><?php echo $LDUpdateweberppricing; ?></TD>
</tr>
<TR>
	<td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
	<TD class="submenu_item"><nobr><a href="pharmacy_tz_search2.php"><?php echo $LDSearch; ?></a></nobr></TD>
