	      ...
	      <table border=0 cellspacing=1 cellpadding=3 class="product_table">
            <tbody class="submenu">
              ...
              <tr>
                ...
                <td align=right width=32>&nbsp;</td>
                <td width=145 align=right class="product_price"><p>Item Partcode</p>
                </td>
               <td width="594"><input type="text" name="partcode" value="<?PHP echo $partcode;?>" <?php echo $html_disabler;?> size=20 maxlength=20></td>
              </tr>
              <tr>
                <td align=right width=103>&nbsp;</td>
                <td width=30 align=right class="classification">&nbsp;</td>
