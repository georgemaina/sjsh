...
td.pblock{ font-family: verdana,arial; font-size: 12px}
td.pv{ font-family: verdana,arial; font-size: 12px; color: #0000cc}

div.box { border: solid; border-width: thin; width: 100% }

div.pcont{ margin-left: 3px; }
...
echo '<tr>
		...
		<td background="'.$bgc.'"><font face="verdana,arial" size="2" >&nbsp;<nobr><b>'.$LDFirstBedNo.'</b></nobr></td>
		<td background="'.$bgc.'"><font face="verdana,arial" size="2" >&nbsp;<nobr><b>'.$LDLastBedNo.'</b></nobr></td>
		<td background="'.$bgc.'"><font face="verdana,arial" size="2" > <b>&nbsp;fdf '.$LDRoomShortDescription.' &nbsp;</b></td>
		<td background="'.$bgc.'"><font face="verdana,arial" size="2" >&nbsp;<nobr><b>'.$LDRoomCharge.'</b></nobr></td>
		<td background="'.$bgc.'"><font face="verdana,arial" size="2" >&nbsp;<nobr><b>'.$LDNursingCharge.'</b></nobr></td>
		<td background="'.$bgc.'"><font face="verdana,arial" size="2" >&nbsp;<nobr><b>'.$LDDoctorsCharge.'</b></nobr></td>
		<td background="'.$bgc.'"><font face="verdana,arial" size="2" >&nbsp;<nobr><b>'.$LDAccomCharge.'</b></nobr></td>
...
$toggle=0;
	...
	<td>&nbsp;<font color="#ff0000"><b>*</b><input type="text" name="beds'.$i.'" size=3 maxlength=3 value=""></td>
	 <td>&nbsp;<font color="#ff0000"><b>*</b><input type="text" name="firstBedNoArr'.$i.'" size=3 maxlength=3 value=""></td> 
	 <td>&nbsp;<font color="#ff0000"><b>*</b><input type="text" name="firstBedNoArr'.$i.'" size=3 maxlength=3 value=""></td> 
	<td>&nbsp; <input type="text" name="info'.$i.'" size=60 maxlength=100 value=""></td> 
	<td>&nbsp;<font color="#ff0000"><b>*</b><input type="text" name="roomCostArr'.$i.'" size=4 maxlength=4 value=""></td> 
	<td>&nbsp;<font color="#ff0000"><b>*</b><input type="text" name="roomCostArr2'.$i.'" size=4 maxlength=4 value=""></td> 
	<td>&nbsp;<font color="#ff0000"><b>*</b><input type="text" name="roomCostArr3'.$i.'" size=4 maxlength=4 value=""></td> 
	<td>&nbsp;<font color="#ff0000"><b>*</b><input type="text" name="roomCostArr4'.$i.'" size=4 maxlength=4 value=""></td> 
	</tr>';
	}
?>
</table>
