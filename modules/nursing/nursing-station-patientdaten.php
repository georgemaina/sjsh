...
function printLabResults(pid,encNo){
	...
	if ($edit) return 'onClick="javascript:pullRosebar(this)"></a>';
       ...
       /* Now create the first group of color event signaller */
		...
		<!--<input type="button" onClick="javascript:enlargewin();window.location.href=\'nursing-station-patientdaten-kurve.php'.URL_REDIRECT_APPEND.'&station='.$station.'&pn='.$pn.'&edit='.$edit.'\'" value="'.$LDFeverCurve.'">-->
                <!--<input type="button" onClick="javascript:window.location.href=\''.$root_path.'modules/registration_admission/show_weight_height.php'.URL_APPEND.'&pid=$pid&target=$target" value="'."Vital Signs".'">-->                    
		<input type="button" onClick="window.location.href=\''.$root_path.'modules/diagnostics_tz/icd10_quicklist.php?sid='.$sid.'&encounter='.$pn.'&lang=en&ntid=false&externalcall=true&target=search&1=1&ispopup=true&backpath_diag='.urlencode($_SERVER["PHP_SELF"].URL_APPEND.'&pn='.$pn).'\'" value="'.$LDDiagnoses.'">
                <input type="button" onClick="javascript:window.location.href=\''.$root_path.'modules/registration_admission/show_notes.php'.URL_REDIRECT_APPEND.'&station='.$station.'&pn='.$pn.'&user_origin='.$user_origin.'&edit='.'1'.'\'" value="'.'Notes And Reports'.'">      
		...
		<input type="button" onClick="javascript:window.location.href=\''.$root_path.'modules/laboratory_tz/labor_datalist_noedit.php'.URL_REDIRECT_APPEND.'&station='.$station.'&pn='.$pn.'&user_origin='.$user_origin.'&edit='.$edit.'\'" value="'.$LDLabReports.'"><br>
		...
		<input type="button" onClick="javascript:window.location.href=\''.$root_path.'modules/radiology/view_person_search.php'.URL_REDIRECT_APPEND.'&station='.$station.'&pn='.$pn.'&user_origin='.$user_origin.'&edit='.$edit.'\'" value="'.'X-Ray Reports'.'">';
