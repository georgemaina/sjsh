...
//        sex=sx;
//        ward_no=wd;
//        if(ward_no==1|| ward_no==4 || ward_no==5){
//            if(sex=='m'){
//                alert("<?php //echo $LDPladmMale2; ?>//");
//                //                 d.transfere.focus();
//                //                 return false;
//            }else{
...
<table border=0 cellpadding=4 cellspacing=1 width=100%>
    ...
    while ($ward = $ward_info->FetchRow()) {
	 ...
	 <td>' . $ward['name'] . '</td>
	 <td id="transfere"><a href="javascript:TransferWard(\'' . $ward['nr'] . '\',\'' . $sx . '\')"><img ' . createLDImgSrc($root_path, 'transfer_sm.gif', '0') . '></a></td></tr>';
    }
    ?>
