...
# Title in toolbar
 ...
 $smarty->assign('sToolbarTitle', $LDNotes.' :: '.$$station.' ('.formatDate2Local($s_date,$date_format,false,false,'-').')');
 ...
 # Window bar title
 $smarty->assign('sWindowTitle',$LDNotes.' :: '.$$station.' ('.formatDate2Local($s_date,$date_format,false,false,'-').')');
...
?>
  ...
  <tr  class="<?php echo $sRowClass ?>"  valign="top">
    <td><?php if(!empty($row['date'])) echo @formatDate2Local($row['date'],$date_format,FALSE,FALSE,'-'); ?></td>
