<script>
    ...
    sgrid.setHeader("item number,item_type,Description,price,qty,total");
    sgrid.setInitWidths("80,100,270,100,60,100");
    sgrid.setSkin("light");
    sgrid.setColTypes("ed,ed,ed,ed,ed,ed");
    ...
    function stateChanged9()
    {
        ...
        if (xmlhttp9.readyState==4)//show point desc
        {
            ...
            document.debit.receiptNo.value=str2[6];
