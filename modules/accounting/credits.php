...
//    jsIncludes();
    ...
    echo "<table width=100% border=0>
        <tr class='titlebar'><td colspan=2 bgcolor=#99ccff><font color='#330066'>Credits</font></td></tr>
    ...
    echo '</td><td width=80%>';
     ...
     function updateDbtErp($db,$pn) {
      ...
      $debug=false;;
        ...
        $sql="SELECT pid, total AS price,rev_code,Description AS article,bill_date,qty,total AS amount,bill_number
                     FROM care_ke_billing WHERE pid='$pn' AND weberpSync=0";
        if($debug) echo $sql;
