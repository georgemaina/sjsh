...
//echo $sql;
    ...
    $sqlS = "SELECT * FROM care_ke_billing WHERE pid = '$q' and `IP-OP`=1 and 
service_type NOT IN ('payment','payment adjustment','NHIF') and bill_number=$billNumber order by bill_date asc";
    ...
    if ($resultS = $db->Execute($sqlS)) {
        ...
        echo "<table width=100% border=0>
                            ...
                            <td class='tdbolder'><b>Total</b></td><td class='tdbolder'><b> Running Totals</b></td><tr><b>";
        ...
        while ($rowS = $resultS->FetchRow()) {
            if ($rowS['IP-OP'] == 1) {
                ...
                echo "<tr>  <td>" . $rowS['prescribe_date'] . "</td>
                        ...
                        <td>" . number_format(intval($rowS['total']),2) . "</td>
                        <td>" . number_format($runningTotals,2).  "</td>
                  <tr>";
                
            } else {
                echo " <tr><td class='tdbolder' colspan=7>This Patient Is not an Inpatient
        ...
        echo "<table width=100% border=1>
          <tr><td class='tdbolder' colspan=7>There are no Pending Bills for this Patient.</td><tr><b>";
    }
