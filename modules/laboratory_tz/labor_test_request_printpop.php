...
$sql="SELECT pid,Selian_pid,name_first,name_last,name_2  FROM care_person
WHERE pid=(SELECT pid FROM care_encounter WHERE encounter_nr=$pn)";
$request=$db->Execute($sql);
$row=$request->FetchRow();
$h_selian_file_number=$row[Selian_pid];
$h_pid=$row[pid];
$h_name_last=$row[name_last];
$h_name_first=$row[name_first];
$h_surname=$row[name_2];
