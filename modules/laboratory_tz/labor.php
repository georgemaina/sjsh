...
function open_request()
{
	...
	requestwin=window.open(urlholder,"requestwin_2","menubar=no,resizable=yes,scrollbars=yes,status=yes,width="+screen.width +",height="+ screen.height +",");
...
*/
  ...
  $smarty->assign('LDTestResults',"<a href=\"labor_test_results_edit_pass.php?sid=$sid&lang=$lang&user_origin=lab\">$LDTestResults</a>");
  $smarty->assign('LDTestResultsTxt',$LDTestResultsTxt);
