...
//                                                                        require_once($root_path.'modules/accounting/billing_ke_create_quote.php');
//									//echo $sql;
...
<table border=0>
	<tr valign="top">
		...
		<?php echo createLDImgSrc($root_path,'printout.gif','0','absmiddle') ?>
			...
			require_once($root_path.'include/care_api_classes/class_tz_billing.php');
			$bill_obj = new Bill;
			$bill_status = $bill_obj->GetBillStatus($batch_nr);
			if($bill_status['bill_status']=='pending')
                            echo '<br><br><img src="../../gui/img/common/default/warn.gif" border=0 alt="" style="filter:alpha(opacity=70)"> <font color="red">'.$LDLabRequestNotBilled.'</font> <img src="../../gui/img/common/default/warn.gif" border=0 alt="" style="filter:alpha(opacity=70)">';
                        else
                            echo '<br><br><font color="green">'.$LDLabRequestBilled.' '.$bill_status['bill_number'].'</font><br><br>';
       //create a bill
       // echo "&nbsp&nbsp&nbsp <a href='../accounting/billing_ke_create_quote.php?batchno=$batch_nr&pid=$h_pid&encounterNr=$pn&target=$target'><b>Bill the patient<b></a><br><br>";
