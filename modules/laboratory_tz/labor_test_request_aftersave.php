...
if($user_origin=='lab')
{
  ...
  if($target=='radio') $breakfile=$root_path.'modules/radiology/radiolog.php'.URL_APPEND;
   else $breakfile=$root_path.'modules/laboratory_tz/labor.php'.URL_APPEND;
}
...
function printOut()
{
	urlholder="<?php echo $root_path; ?>modules/nursing/lab_request_pdf.php?sid=<?php echo $sid ?>&lang=<?php echo $lang ?>&user_origin=<?php echo $user_origin ?>&subtarget=<?php echo $target ?>&batch_nr=<?php echo $batch_nr ?>&pn=<?php echo $pn ?>";
