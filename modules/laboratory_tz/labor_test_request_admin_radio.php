...
.fva2_ml10 {font-family: verdana,arial; font-size: 12px; margin-left: 10px; color:#000000;}
.fva2b_ml10 {font-family: verdana,arial; font-size: 12px; margin-left: 10px; color:#000000;}
.fva0_ml10 {font-family: verdana,arial; font-size: 10px; margin-left: 10px; color:#000000;}
</style>
...
<?php 
$sql="select item_full_description from care_tz_drugsandservices where partcode='".$stored_request['test_request']."'";
if($debug) echo $sql;
...
?>
	...
	<tr bgcolor="<?php echo $bgc1 ?>">
		...
		<font face="courier" size=2 color="#000000">&nbsp;<?php 
					  ...
					  echo formatDate2Local($stored_request['send_date'],$date_format,false,false,'-');
