...
if(isset($mode) && !empty($mode)) {
	if($mode=='save'){
		...
		$_POST['id'] = "_" . cleanString(strtolower($_POST['name'])) . '__' . strtolower(trim($_POST['group_id']));
...
//                    $das_obj->updateDrugsAndServices('LAB'.$_POST['nr'],$_POST);
			...
			if(!empty($_POST['field_type']) && !empty($_POST['input_value'])) {
				...
				//i'm dealing with ranged values
					...
					$lab_obj->insertDataFromArray($paramValue);
                          ...
                          $sql2='Update care_tz_laboratory_param set weberp_syncd="1"
...
<td bgcolor="<?php echo $cfg['top_bgcolor']; ?>" height="10" align=right ><nobr>
    <a href="javascript:gethelp('lab_param_edit.php')"><img
...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="0"><?php echo $LDInputPrice ?></li>
...
$toggle=0;
	...
	<tr><td  class="a12_b" bgcolor="#fefefe">&nbsp;'.$LDParameter.'</td>
			<td bgcolor="'.$bgc.'"  class="a12_b"><input type="text" name="name" size=30 maxlength=30 value="'.$tp['name'].'">&nbsp;
			</td></tr>
			';
...
//Price setup
        	echo '<div class="TabbedPanelsContent"><table border="0" cellpadding=2 cellspacing=1>
	<tr><td  class="a12_b" bgcolor="#fefefe">&nbsp;'.$LDInputpriceType.'</td>
			<td bgcolor="'.$bgc.'"  class="a12_b"><input type="text" name="price" size=15 maxlength=15 value="'.$tp['price'].'">&nbsp;<br>
			</td></tr>
			';
	echo '</table></div>
			';
	...
	<tr><td  class="a12_b" bgcolor="#fefefe">&nbsp;'.$LDInputType.'</td>
			...
			<select name="field_type" size="1">
  				...
  				<option value="group_field"'; if ($tp['field_type']=='group_field') echo "selected"; echo '>'.$LDInputTypeGroup.'</option>
			</select>
			&nbsp;
			</td></tr>
			';
