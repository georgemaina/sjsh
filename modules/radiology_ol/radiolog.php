...
$aSubMenuItem=array('LDTestRequestRadio' => "<a href=\"".$root_path."modules/laboratory_tz/labor_test_request_pass.php".URL_APPEND."&target=radio&user_origin=radio\">$LDTestRequestRadio</a>",
                'LDTestReception' => "<a href=\"".$root_path."modules/laboratory_tz/labor_test_request_pass.php".URL_APPEND."&target=admin&subtarget=radio&user_origin=radio\" >$LDTestReception</a>",
