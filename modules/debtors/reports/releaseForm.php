...
//    require_once 'Zend/Pdf.php';
    ...
    $page->setStyle($headlineStyle1);
        ...
        $page->drawText("UB RELEASE FORM", $leftPos + 20, $topPos - 50);
        ...
        $sql = "SELECT `accno`,d.`name`,c.`name` AS category,`address1`,`address2`,`phone`,`altPhone`,`contact`,`email`,`joined`,
            ...
            `guaranteeDate`, `guarantorsAmount`,nextPaymentDate,openingBL,otherInfo,statementInfo,openingBL FROM care_ke_debtors d
       ...
       // $page->setFont(Zend_Pdf_Font::fontWithName(Zend_Pdf_Font::FONT_HELVETICA_BOLD_ITALIC), 8);
        ...
        $page->drawText($row[guaranteeDate] , $leftPos + 80, $topPos - 380);
