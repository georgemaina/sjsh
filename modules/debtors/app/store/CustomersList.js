/*
 * File: app/store/CustomersList.js
...
Ext.define('Debtors.store.CustomersList', {
    extend: 'Ext.data.Store',
    alias: 'store.customerslist',

    requires: [
        'Debtors.model.customersList',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            ...
            model: 'Debtors.model.customersList',
            proxy: {
                type: 'ajax',
