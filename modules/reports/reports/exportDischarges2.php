...
$worksheet=$workbook->addWorksheet('Discharge Report');
...
$indexCol = 0; // Start @ column 0
   ...
   $sql = "SELECT  e.pid,e.newAdm_No,p.name_first,p.name_last,p.name_2,p.sex,p.date_birth,e.encounter_date,e.encounter_time,
    e.discharge_date,(DATEDIFF(e.discharge_date,e.encounter_date)) AS bDays,e.current_ward_nr FROM care_encounter e 
...
$workbook->send('Discharge Report '.date('Hms').'.xls');
