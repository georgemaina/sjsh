...
<style type="text/css" name="1">
    ...
    .myMessage{font-size: small;color: #ffffff;background-color: #cc0033;
    ...
    <form name="finalize" method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
        <table border="0" class="pg1">
            ...
            <tbody>
                ...
                <tr>
                    <td>Date</td>
                    <td><input type="text" id="fdate" name="fdate" value="" /></td>
...
//                            </td></tr>';
                ...
                echo '<tr><td>date:</td>';
                echo '<td><input type="text" name="debitDate" id="debitDate" value="'.date("d-m-Y").'" /></td></tr>';
...
<script>
    function exportExcel(str){
        window.open('exportStatement.php?acc1='+str+'&rptType=statement'
    ...
    function printStatement(str){
        ...
        window.open('reports/statement_pdf.php?acc1='+str+'&rptType=statement'
        ,"Reports","menubar=yes,toolbar=yes,width=500,height=550,location=yes,resizable=no,scrollbars=yes,status=yes");
    }
