<?php
    ...
    if($target=='Debit'){
        ...
        $allowedarea=$allow_area['credit'];
        $fileforward="credits.php?sid=".$sid."&lang=".$lang;
    }else if($target=='creditSlips'){
        $allowedarea=$allow_area['creditslip'];
        $fileforward="creditslip.php?sid=".$sid."&lang=".$lang;
    }else if($target=='viewSlips'){
        $allowedarea=$allow_area['creditslipview'];
        $fileforward="viewslips.php?sid=".$sid."&lang=".$lang;
    }
