...
//echo $sql2;
    ...
    $page->drawText('Date', $leftPos + 20, $topPos - 205);
    $page->drawText('Service Description:', $leftPos + 80, $topPos - 205);
...
//    $topPos = $topPos - $currpoint;
    ...
    $sqli = "SELECT * FROM care_ke_billing WHERE (pid ='" . $pid . "' AND service_type IN
            ('payment','payment adjustment','NHIF') and `ip-op`=2 and bill_number=$billNumber)";
