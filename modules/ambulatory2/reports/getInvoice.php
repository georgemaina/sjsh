...
WHERE (pid ='" . $q . "' AND service_type not in
    ('Payment','payment adjustment','NHIF') and `ip-op`=2) and bill_number=$billNumber group by service_type";
//echo $sql3;
    ...
    $sql6 = "SELECT sum(total) as total FROM care_ke_billing WHERE pid = '$q' and `IP-OP`=2 and
