...
require('roots.php');
    echo "<table width=100% border=0>
        <tr class='titlebar'><td colspan=2 bgcolor=#99ccff><font color='#330066'>OP List of Invoices</font></td></tr>
...
<script type="text/javascript" src="getPendingInvoices.js"></script>
<script>
