...
function getTreatmentData($encNo){
    ...
    $strout="<table border=1 width=100%><tr><td colspan=6 ALIGN=center> VITALS</td></tr><tr><td>Weight</td><td>Height</td><td>Temperature</td><td>BP</td><td>Purse</td><td>Respiratory</td></tr>";
//    foreach ()
...
function getItemsList($searchParam,$start,$limit) {
    ...
    while ($row = $result->FetchRow()) {
        ...
        . '","Category":"' . $row['item_Cat'] . '","Price":"' . $row['unit_price'] . '"}';
