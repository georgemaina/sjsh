...
$diagnosis=$diagnos_obj->checkCurrentEncounterDignosis($_SESSION['sess_en']);
...
if($diagnosis==0){
    $diagnosisErr= "There is no Diagnosis record for ".$title.' '.$name_last.": Click Here to Enter Diagnosis";
}
