...
if(!$_SESSION['sess_pid']) $_SESSION['sess_pid'];
if(!$_SESSION['sess_full_pid']) $_SESSION['sess_full_pid'];
if(!$_SESSION['sess_en']) $_SESSION['sess_en'];
if(!$_SESSION['sess_full_en']) $_SESSION['sess_full_en'];
