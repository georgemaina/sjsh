			...
			?>
               <TR> <td align=center><img <?php echo createComIcon($root_path,'pdata.gif','0','',FALSE) ?>></td>
                <TD vAlign=top ><FONT 
				 ...
				 <a href="aufnahme_daten_zeigen.php<?php echo URL_APPEND ?>&encounter_nr=<?php echo $current_encounter['encounter_nr'] ?>&origin=patreg_reg"><?php echo $LDPatientData; ?></a>
				  </nobr> </FONT></TD>
                </TR>
...
<!-- 			   
 ...
 -->				
		...
		<TR><td align=center><img <?php echo createComIcon($root_path,'icon_acro.gif','0','',FALSE) ?>></td>
                     <TD vAlign=top width=150><font face="Verdana,Helvetica,Arial" size=2> 
                            <a href="<?php echo "patientHistory.php".URL_APPEND."&pid=".$pid ?>" target=_blank><?php echo $LDPatientHistory ?></a>
                    </font></TD>
                </TR>
           <?php Spacer(); ?>
				  <TR><td align=center><img <?php echo createComIcon($root_path,'icon_acro.gif','0','',FALSE) ?>></td>
