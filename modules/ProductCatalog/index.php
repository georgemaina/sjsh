 ...
 */
    ...
    $fileforward=$root_path."modules/ProductCatalog/index.html?sid=$sid&lang=$lang&from=$from";

    $thisfile="index.php";
    $breakfile="index.php?sid=".$sid."&lang=".$lang;
...
<FONT    SIZE=-1  FACE="Arial">
    ...
    <font  COLOR='#330066'  SIZE=6  FACE="verdana"><b><?php echo $LDNursingManage ?>
    </b></font>
     <!-- <font  COLOR=<?php echo $cfg[top_txtcolor] ?>  SIZE=6  FACE="verdana"><b><?php echo $LDNursingManage ?></b></font> -->
     <font  COLOR='#330066'  SIZE=6  FACE="verdana"><b><?php echo $LDNursingManage ?></b></font>
