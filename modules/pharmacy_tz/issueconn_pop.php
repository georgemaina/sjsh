...
$gridConn->render_sql("SELECT c.partcode,c.item_description,d.stockid,d.quantity,c.unit_price FROM care_tz_drugsandservices c
INNER JOIN care_ke_locstock d ON d.stockid=c.partcode","partcode", "stockid,item_description,unit_price");
