...
function open_pending_prescriptions() {
	urlholder="<?php echo $root_path;?>modules/pharmacy_tz/pharmacy_ke_store_pass.php?target=prescription&sid=<?php echo $sid."&lang=".$lang;?>&prescrServ=prescr&comming_from=pharmacy";
...
<!--                      <tr>
                        ...
                        <td class="submenu_item"><nobr><a href="pharmacy_tz_search2.php"><?php echo $LDMyProductCatalog ; ?></a></nobr></td>
                        <td><?php echo $LDCreateEditUpdateRemove; ?></td>
                      </tr>-->
<!--                      <tr>-->
<!--                        <td align=center><img src="../../gui/img/common/default/templates.gif" border=0 width="16" height="17"></td>-->
<!--                        <td class="submenu_item"><nobr><a href="stockmaster/app.html">--><?php //echo $LDMyProductCatalog; ?><!--</a></nobr></td>-->
<!--                        <td>--><?php //echo $LDCreateEditUpdateRemove; ?><!--</td>-->
<!--                      </tr>-->
<!--                      <tr  height=1>-->
...
<!--                      </tr>-->
                      ...
                      <tr>
                        ...
                        <td align=center><img src="../../gui/img/common/default/documents.gif" border=0 width="16" height="17"></td>
                        <td class="submenu_item"><nobr><a href="./pharmacy_ke_store_pass.php?target=orders"><?php echo $LDOrderProducts; ?></a></nobr></td>
                    ...
                    <tr>
                        <td align=center><img src="../../gui/img/common/default/documents.gif" border=0 width="16" height="17"></td>
                        <td class="submenu_item"><nobr><a href="./pharmacy_ke_store_pass.php?target=issue"><?php echo $LDIssueDrugs; ?></a></nobr></td>
                        <td><?php echo $LDIssueingDrugs; ?></td>
                      </tr>
                       <tr>
                        <td align=center><img src="../../gui/img/common/default/documents.gif" border=0 width="16" height="17"></td>
                        <td class="submenu_item"><nobr><a href="./pharmacy_ke_store_pass.php?target=trans"><?php echo $LDTransfere; ?></a></nobr></td>
                        <td><?php echo $LDTransfering; ?></td>
                      </tr>
<!--                      <tr>
                        <td align=center><img src="../../gui/img/common/default/documents.gif" border=0 width="16" height="17"></td>
                        <td class="submenu_item"><nobr><a href="./pharmacy_ke_store_pass.php?target=cancel"><?php echo $LDCancelOrder; ?></a></nobr></td>
                        <td><?php echo $LDCancellingOrders; ?></td>
                      </tr>-->
                      <tr>
                        <td align=center><img src="../../gui/img/common/default/documents.gif" border=0 width="16" height="17"></td>
                        <td class="submenu_item"><nobr><a href="./pharmacy_ke_show_return.php"><?php echo $LDReturn; ?></a></nobr></td>
                        <td><?php echo $LDReturning; ?></td>
                      </tr>
<!--                      <tr>
                        <td align=center><img src="../../gui/img/common/default/documents.gif" border=0 width="16" height="17"></td>
                        <td class="submenu_item"><nobr><a href="./pharmacy_ke_show_stockAdj.php"><?php echo $LDStockAdjust; ?></a></nobr></td>
                        <td><?php echo $LDStockAdjustemt; ?></td>
                      </tr>-->
                      <tr>
                        <td align=center><img src="../../gui/img/common/default/documents.gif" border=0 width="16" height="17"></td>
                        <td class="submenu_item"><nobr><a href="./pharmacy_ke_store_pass.php?target=levels"><?php echo $LDStockLevels; ?></a></nobr></td>
                        <td><?php echo $LDStockVlevels; ?></td>
                      </tr>
                       <tr>
                        <td align=center><img src="../../gui/img/common/default/documents.gif" border=0 width="16" height="17"></td>
                        <td class="submenu_item"><nobr><a href="./pharmacy_ke_show_stCount.php"><?php echo $LDStockCount; ?></a></nobr></td>
                        <td><?php echo $LDStockVCounts; ?></td>
                      </tr>
                      <tr>
                        <td align=center><img src="../../gui/img/common/default/documents.gif" border=0 width="16" height="17"></td>
                        <td class="submenu_item"><nobr><a href="./stockcounts.php">Preview Stock Counts</a></nobr></td>
                        <td>Preview Stock Counts</td>
                      </tr>
                      <tr>
                        <td align=center><img src="../../gui/img/common/default/documents.gif" border=0 width="16" height="17"></td>
                        <td class="submenu_item"><nobr><a href="./pharmacy_ke_show_Reports.php"><?php echo $LDPharmReports; ?></a></nobr></td>
                        <td><?php echo $LDStockVlevels; ?></td>
                      </tr>
                    </TBODY>
                  </TABLE>
