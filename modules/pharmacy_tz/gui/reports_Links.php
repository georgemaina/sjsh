                        ...
                        <blockquote>
                            <TABLE cellSpacing=0 class="submenu_frame" cellpadding="0">
                                <TBODY>
                                    ...
                                    <TR>
                                        <td align=center><img src="../../gui/img/common/default/documents.gif" border=0 width="16" height="17"></td>
                                        <TD class="submenu_item"><nobr><a href="./pharmacy_ke_DisplayRpt.php?title=valuation"><?php echo $LDStockValuation; ?></a></nobr></TD>
                                        <?php echo $title?"":"<TD>View " . $LDStockValuation."</TD>" ?>
                                    </tr>
                                    <TR>
                                        <td align=center><img src="../../gui/img/common/default/documents.gif" border=0 width="16" height="17"></td>
                                ...
                                <TR>
                                    <td align=center><img src="../../gui/img/common/default/documents.gif" border=0 width="16" height="17"></td>
                                    <TD class="submenu_item"><nobr><a href="./pharmacy_ke_DisplayRpt.php?title=dreturns"><?php echo $LDReturns; ?></a></nobr></TD>
