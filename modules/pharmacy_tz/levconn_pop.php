...
INNER JOIN care_ke_locstock d ON d.stockid=c.partcode WHERE purchasing_class in('Drug_list','MEDICAL-SUPPLIES')","partcode", "stockid,item_description,quantity,reorderlevel,unit_price");
