...
<table class="style1">
   ...
   <tr valign="top"  class="prow2">
    ...
    <tr class="prow2">
        <td>Payment Mode:</td>
        <td>
            <SELECT id="paymode" name="paymode" onchange="showPayDesc(this.value)" onblur="showPayDesc(this.value)">
    ...
    <tr class="prow2">
        ...
        <td> <input type="hidden" name="myform_key" value="<?php echo md5("$prefix . $receipt_no"); ?>" /></td>
        <td></td>
        <td></td>
    </tr>
