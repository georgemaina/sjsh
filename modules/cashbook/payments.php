...
//            add_data_to_database($_POST);
    ...
    displayPayForm($db,$cashpoint,$cashier);
    ...
    $PaymentMode=$paymode;
    if($pledger=='PC'){
        displayPettyCash($cashpoint,$payMode,$voucherNo);
    }else{
        displayVoucher($cashpoint,$payMode,$voucherNo);
        displayChequeVoucher($cashpoint,$payMode,$voucherNo);
    }
...
<!--        window.location = "welcome.php?cashpoint=--><?php //echo $cashpoint &shiftNo=//echo $shiftNo ?>
<!--    </script> -->
    <?php
//}
