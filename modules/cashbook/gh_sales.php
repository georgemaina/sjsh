...
echo '<tr valign="top" class="pgtitle">
        <td colspan="2">Guest Hostel Sale</td></tr>';
...
//    $payer=$_REQUEST["payer"];
        require('GHcashconn.php');

        GHdisplaySaleForm($db, $cashpoint, $cashier, $receipt_no, $cname, $prefix);
...
//$File = "C:/Program Files/2xp/receipt.txt";
        ...
        displayReceipts($rdate, $refno, $cashier, $pno, $PatientName, $PaymentMode, $cash_point, $payer, $reprint, $shiftNo);
    } else {
        GHdisplaySaleForm($db, $cashpoint, $cashier, $receipt_no, $cname, $prefix);
    }
} else {
