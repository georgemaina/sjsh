...
function insertData($db,$rowid,$cash_point,$ref_no,$paymode,$mydate,$payer,$patientno,
    $pname,$gl_acc,$cheque_no,$inputDt,$inputTime,$period,$shiftNo,$username,$bill_number,$bill_obj) {
      $debug=false;
    //global $db;
    ...
    $csql="INSERT INTO `care_ke_receipts`
            ...
            ('".$cash_point."', '$ref_no','$paymode','RCJ','".date('Y-m-d')."','$payer','$patientno',
...
//        echo 'gridbox fields are'.$rows.'<br>';
    ...
    $pname,$gl_acc,$cheque_no,$inputDt,$inputTime,$period,$shiftNo,$username,$row3[2],$bill_obj);
