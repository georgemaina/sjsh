...
//    require ('roots.php');
    ...
    $pdf = new Zend_Pdf ();
    $page = new Zend_Pdf_Page(672, 384);

    $pageHeight = 384;
    $width = 672;
    $topPos = $pageHeight - 100;
    $leftPos = 10;
...
//        echo $r_sql;
        ...
        $page->setStyle($headlineStyle);
        $page->drawText(date('d-m-Y'), $leftPos + 550, $topPos - 30);
        $page->drawText(number_format($row[total], 2), $leftPos + 550, $topPos - 150);
        $page->drawText($row[payee], $leftPos + 80, $topPos - 220);

        $f = new NumberFormatter("en", NumberFormatter::SPELLOUT);
        $words= $f->format($row ['total']);
