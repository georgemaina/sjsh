...
//        $page->drawText ( strtoupper($amtWords).' ONLY', $leftPos + 120, $topPos - 80 );
    ...
    $page->drawText("_____________________________", $leftPos + 34, $topPos - 330);
    ...
    $page->drawText("______________________________", $leftPos + 36, $topPos - 500);
    $page->drawText("Received By:", $leftPos + 36, $topPos - 510);
    $page->drawText("Date ", $leftPos + 200, $topPos - 510);
    $page->drawText("___________________________", $leftPos + 200, $topPos - 500);
    $page->drawText("Signature ", $leftPos + 400, $topPos - 510);
    $page->drawText("___________________________", $leftPos + 400, $topPos - 500);
...
//    $page->drawText($email, $leftPos + 240, $topPos - 80);
    ...
    $headlineStyle2->setFont($font, 13);
    $page->setStyle($headlineStyle2);
    $page->drawText($title, $leftPos + 37, $topPos - 36);
    $page->drawRectangle($leftPos + 37, $topPos - 25, $leftPos + 500, $topPos - 25, Zend_Pdf_Page::SHAPE_DRAW_FILL_AND_STROKE);
    $page->drawRectangle($leftPos + 37, $topPos - 39, $leftPos + 500, $topPos - 39, Zend_Pdf_Page::SHAPE_DRAW_FILL_AND_STROKE);
