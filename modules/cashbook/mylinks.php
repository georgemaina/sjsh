...
//    echo "<tr class='tr1'><td><a href='cashbook_ke_storepass.php?target=iou'>IOU Form</a></td></tr>";
...
function displaySaleForm($db,$cashpoint,$cashier,$receipt_no,$cname,$prefix) {
   ...
   //echo "<div class='container' style='width:600px'>";
    ...
    echo "<tr>
             <td colspan='5' align=center><br><div id='gridbox' height='150px' style='background-color:white;'></div></td></tr>";
    echo "<tr>
             <td colspan='4' align='right'><b>Total: <b/></td>
             <td><input type='text' name='total' id='total' onblur='sumColumn(6)' onfocus='sumColumn(6)'></td></tr>";
    echo "<tr>
             <td colspan='4' align='right'><b>Received Cash: <b/></td>
             <td><input type='text' name='cash' id='cash' value='0' onchange='getBalance(this.value)'></td></tr>";
    echo "<tr>
             <td colspan='4' align='right'><b>Received Mpesa:<b/></td>
             <td>  <input type='text' name='mpesa' id='mpesa' value='0' onchange='getBalance(this.value)'>
                    Mpesa Ref: <input type='text' name='mpesaref' id='mpesaref' size='10' value='' minlength='10' maxlength='10'><b/></td></tr>";
    echo "<tr>
             <td colspan='4' align='right'><b>Visa: <b/></td>
             <td><input type='text' name='visa' id='visa' value='0' onchange='getBalance(this.value)'></td></tr>";
    echo "<tr>
             <td colspan='4' align='right'><b>Balance:<b/></td>
             <td> <input type='text' name='bal' id='bal' value='0'></td></tr>";
    echo "<tr>
             <td colspan=4 align=right></td>
             <td><input type='submit' id='submit' name='submit' value='Save' size='10'></td>
          </tr>
          </table>
          </form>";
...
function displaySaleAdj($db,$cashpoint,$cashier,$cname){
     $debug=false;
...
function displayReceipt($cash_point,$refno,$cashier,$paymode,$payer,$chequeNo,$patientid,$patientname,
    ...
    ?>
<script>
    window.open('http://localhost:82/receipt/index.php?refno=<?php echo $refno ?>&cashier=<?php echo $cashier?>&paymode=<?php echo $paymode?>\
...
function printReceipt($rdate,$refno,$cashier,$pno,$PatientName,$PaymentMode,$cashpoint,$payer,$reprint) {
    ?>
<script>
    window.open('reports/newreceipt.php?refno=<?php echo $refno ?>&cashier=<?php echo $cashier?>&paymode=<?php echo $paymode?>\
&payer=<?php echo $payer?>&patientid=<?php echo $patientid?>&patientname=<?php echo $patientname?>\
...
function getBalance(str){
    ...
    function displayReceipts($rdate,$refno,$cashier,$pno,$PatientName,$PaymentMode,$cashpoint,$payer,
            $reprint,$shiftno,$inputTime) {
    ?>
<script>
    window.open('reports/newreceipt.php?rdate=<?php echo $rdate ?>&refno=<?php echo $refno ?>\
...
&payer=<?php echo $payer ?>&reprint=<?php echo $reprint ?>&inputTime=<?php echo $inputTime ?>'
,"receipt","menubar=no,toolbar=no,width=300,height=550,location=yes,resizable=no,scrollbars=no,status=yes");
...
function displayReceiptsOld($rdate,$refno,$cashier,$pno,$PatientName,$PaymentMode,$cashpoint,$payer,
                         $reprint,$shiftno,$inputTime) {
    ?>
    <script>
...
function displayVoucher($CashPoint, $payMode, $voucherNo) {
    ?>
    <script>
        window.open('reports/payment_voucher.php?cashpoint=<?php echo $CashPoint ?>&voucherNo=<?php echo $voucherNo ?>\
&payMode=<?php echo $payMode ?>&pno=<?php echo $pno ?>&PatientName=<?php echo $PatientName ?>\
&PaymentMode=<?php echo $PaymentMode ?>&cashpoint=<?php echo $cashpoint ?>&shiftno=<?php echo $shiftno ?>\
&payer =<?php echo $payer ?>&reprint =<?php echo $reprint ?>'
            ,"receipt","menubar=no,toolbar=no,width=600,height=600,location=yes,resizable=no,scrollbars=no,status=yes");

        window.open('reports/RequisitionForm.php?cashpoint=<?php echo $CashPoint ?>&voucherNo=<?php echo $voucherNo ?>\
&payMode=<?php echo $payMode ?>&pno=<?php echo $pno ?>&PatientName=<?php echo $PatientName ?>\
&PaymentMode=<?php echo $PaymentMode ?>&cashpoint=<?php echo $cashpoint ?>&shiftno=<?php echo $shiftno ?>\
&payer =<?php echo $payer ?>&reprint =<?php echo $reprint ?>'
            ,"receipt","menubar=no,toolbar=no,width=600,height=600,location=yes,resizable=no,scrollbars=no,status=yes");

        window.open('reports/ChequeVoucher.php?cashpoint=<?php echo $CashPoint ?>&voucherNo=<?php echo $voucherNo ?>\
&payMode=<?php echo $payMode ?>&pno=<?php echo $pno ?>&PatientName=<?php echo $PatientName ?>\
&PaymentMode=<?php echo $PaymentMode ?>&cashpoint=<?php echo $cashpoint ?>&shiftno=<?php echo $shiftno ?>\
&payer =<?php echo $payer ?>&reprint =<?php echo $reprint ?>'
            ,"receipt","menubar=no,toolbar=no,width=600,height=600,location=yes,resizable=no,scrollbars=no,status=yes");
...
function displayChequeVoucher($CashPoint, $payMode, $voucherNo) {
    ?>
    <script>
        window.open('reports/chequePaymentVoucher.php?cashpoint=<?php echo $CashPoint ?>&voucherNo=<?php echo $voucherNo ?>\
&payMode=<?php echo $payMode ?>&pno=<?php echo $pno ?>&PatientName=<?php echo $PatientName ?>\
&PaymentMode=<?php echo $PaymentMode ?>&cashpoint=<?php echo $cashpoint ?>&shiftno=<?php echo $shiftno ?>\
&payer =<?php echo $payer ?>&reprint =<?php echo $reprint ?>'
            ,"receipt","menubar=no,toolbar=no,width=600,height=600,location=yes,resizable=no,scrollbars=no,status=yes");
...
function displayVoucherADJ($CashPoint, $payMode, $voucherNo) {
    ?>
    <script>
        window.open('reports/payment_voucher_Adj.php?cashpoint=<?php echo $CashPoint ?>&voucherNo=<?php echo $voucherNo ?>\
&payMode=<?php echo $payMode ?>&pno=<?php echo $pno ?>&PatientName=<?php echo $PatientName ?>\
&PaymentMode=<?php echo $PaymentMode ?>&cashpoint=<?php echo $cashpoint ?>&shiftno=<?php echo $shiftno ?>\
&payer =<?php echo $payer ?>&reprint =<?php echo $reprint ?>'
            ,"receipt","menubar=no,toolbar=no,width=600,height=600,location=yes,resizable=no,scrollbars=no,status=yes");
...
function displayPettyCash($CashPoint, $payMode, $voucherNo) {
    ?>
    <script>
        window.open('reports/petty_cash.php?cashpoint=<?php echo $CashPoint ?>&voucherNo=<?php echo $voucherNo ?>\
&payMode=<?php echo $payMode ?>&pno=<?php echo $pno ?>&PatientName=<?php echo $PatientName ?>\
&PaymentMode=<?php echo $PaymentMode ?>&cashpoint=<?php echo $cashpoint ?>&shiftno=<?php echo $shiftno ?>\
&payer =<?php echo $payer ?>&reprint =<?php echo $reprint ?>'
            ,"receipt","menubar=no,toolbar=no,width=600,height=600,location=yes,resizable=no,scrollbars=no,status=yes");
...
function displayPettyADJ($CashPoint, $payMode, $voucherNo) {
    ?>
    <script>
        window.open('reports/petty_cash_Adj.php?cashpoint=<?php echo $CashPoint ?>&voucherNo=<?php echo $voucherNo ?>\
&payMode=<?php echo $payMode ?>&pno=<?php echo $pno ?>&PatientName=<?php echo $PatientName ?>\
&PaymentMode=<?php echo $PaymentMode ?>&cashpoint=<?php echo $cashpoint ?>&shiftno=<?php echo $shiftno ?>\
&payer =<?php echo $payer ?>&reprint =<?php echo $reprint ?>'
            ,"receipt","menubar=no,toolbar=no,width=600,height=600,location=yes,resizable=no,scrollbars=no,status=yes");
...
<?php
  ...
  function displayGLReceipts($rdate,$refno,$cashier,$pno,$PatientName,$PaymentMode,$cashpoint,$payer,$reprint,$shiftno,$towards,$inputTime) {
    ?>
<script>
    window.open('reports/newreceipt2.php?rdate=<?php echo $rdate ?>&refno=<?php echo $refno ?>&cashier=<?php echo $cashier ?>&pno=<?php echo $pno ?>&PatientName=<?php echo trim($PatientName) ?>&PaymentMode=<?php echo $PaymentMode ?>&cashpoint=<?php echo $cashpoint ?>&shiftno=<?php echo $shiftno ?>&payer=<?php echo $payer ?>&reprint =<?php echo $reprint ?>&towards=<?php echo $towards ?>&inputTime=<?php echo $inputTime ?>'
    ,"receipt","menubar=no,toolbar=no,width=300,height=550,location=yes,resizable=no,scrollbars=no,status=yes");
...
function displayGLReceiptsOld($rdate,$refno,$cashier,$pno,$PatientName,$PaymentMode,$cashpoint,$payer,$reprint,$shiftno,$towards,$inputTime) {
    ?>
    <script>
        window.open('http://localhost/receipt/indexRCT.php?rdate=<?php echo $rdate ?>&refno=<?php echo $refno ?>&cashier=<?php echo $cashier ?>&pno=<?php echo $pno ?>&PatientName=<?php echo trim($PatientName) ?>&PaymentMode=<?php echo $PaymentMode ?>&cashpoint=<?php echo $cashpoint ?>&shiftno=<?php echo $shiftno ?>&payer=<?php echo $payer ?>&reprint =<?php echo $reprint ?>&towards=<?php echo $towards ?>&inputTime=<?php echo $inputTime ?>'
            ,"receipt","menubar=no,toolbar=no,width=300,height=550,location=yes,resizable=no,scrollbars=no,status=yes");
