...
//                    ,{
//                    text: 'Cheque/Petty Payment Voucher', handler: function() {
//                        var cheqID = '';
//                        var selectedKeys=chequeDetails.selModel.selections.keys;
//                        Ext.each(selectedKeys, function(node){
//                            if(cheqID.length > 0){
...
function displayVoucher(cheqID) {
    ...
    window.open('reports/payment_voucher.php?cheqID='+cheqID
        ,"receipt","menubar=yes,toolbar=no,width=600,height=550,location=yes,resizable=ye,scrollbars=yes,status=yes");
}
