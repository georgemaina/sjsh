...
//							else $sTemp = $sTemp.$result['name'];
    ...
    $sql_con = "SELECT  partcode,item_description FROM care_tz_drugsandservices WHERE purchasing_class IN('CONSULTATION','ADM') order by item_description asc";
    ...
    //			<option value=""></option>';
    $sql_reg = "SELECT  item_description FROM care_tz_drugsandservices WHERE  partcode LIKE 'Reg%' and category='17'";
