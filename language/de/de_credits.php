...
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        ...
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			...
			<font size=1>
			Vorschl�ge zur Sicherheitsverbesserungen<br>
			Schnelle L�sungen zur php Fragen<br>
			Er ist der 'Sentinel' des Projekts
		</font>
		    <p>
			Daniele Frijia (geb. 81) arbeitet momentan bei einem ISP in N�rnberg. Sein PHP Wissen setzt er ein, um
...
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        ...
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			<b>Nino Novak (DE) hat die deutsche Fassung von www.care2x.com komplett �berarbeitet.</b>
			<p>
			Nino Novak ist ein einsamer alter Cowboy, der besser schie�en kann als denken. Manchmal
			etwas pingelig. Diskutiert gerne mit (echten) Gurus.
			M�chte helfen, die Welt zu verbessern. Kam zu Care2x, weil sich seine medizinisch-wissenschaftliche Vergangenheit
...
<TR>
		  ...
		  <P><img src="../../uploads/photos/credits/sven_koechel.jpg" border=0  align=right vspace=10 >
			...
			<p>
			Erstellung und Verwaltung von <a href="http://www.care2x.at" target="_blank">"Team Austria"</a> Webseite f�r Care2x.<br>
...
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        ...
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
		  <P><img src="../../uploads/photos/credits/timon_desktop.jpg" border=0  align=right vspace=10 >
		  <P>
			<b>Timon Royer (DE) </b>
			<p>
			Timon hat den "Care2x-Knoppix" Desktop-Hintergrund erstellt und dem Projekt zur freien Verf�gung gestellt.
...
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        ...
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			...
			Aktivster Debugger und tr�gt u.a. noch folgendes dazu bei:
			<p><font size=1>
			...
			Thomas Wiedmann hat langj�hrige Erfahrung in der Softwareentwicklung und arbeitet in Stuttgart.
			Seit sieben Jahren entwickelt er Programme und L�sungen mit dem Gupta Team Developer und
			der Datenbank IBM DB2.  Weiterhin ist er ein IBM Certified UDB DB2 Administrator. Er ist der Autor des
			Buches "DB2" ISBN 3-932311-80-9 und schreibt regelm�ssig Artikel in der TOOLBOX, eine Zeitschrift
			f�r Software-Entwickler (www.toolbox-mag.de).
...
<TR>
		  ...
		  <P><img src="../../uploads/photos/credits/wilfried_goedert.jpg" border=0  align=right vspace=10 >
			<P><b>Wilfried G�dert (DE)</b><br>
			Tr�gt u.a. folgendes zu dem Projekt bei:
			<p><font size=1>
...
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        ...
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			...
			<br>
Er benutzt Linux und Windows denn: "<i>beide sind grosse Erfindungen der Menschen und m�ssen anerkannt werden</i>".<p>
Er entchied sich f�r "open-source" denn: <br><i>"Eine ideale Welt kann nur �berleben wenn sie im perfekten Gleichgewicht steht. Wenn man
etwas nimmt, sollte man etwas in gleicher Proportion zur�ckgeben."</i>
...
<table border=0 cellspacing=1 cellpadding=1>
  ...
  <tr>
    ...
    <td bgcolor="#f9f9f9"><font face="verdana,arial" size=2>&nbsp;&nbsp;�bersetzung auf portugiesisch</font></td>
  </tr>
  <tr>
    ...
    <td bgcolor="#f9f9f9"><font face="verdana,arial" size=2>&nbsp;&nbsp;�bersetzung auf norwegisch</font></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#f9f9f9"><font face="verdana,arial" size=2>&nbsp;&nbsp;�bersetzung auf franz�sisch</font></td>
  </tr>
  <tr>
    ...
    <td bgcolor="#f9f9f9"><font face="verdana,arial" size=2>&nbsp;&nbsp;�bersetzung auf indonesisch</font></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#f9f9f9"><font face="verdana,arial" size=2>&nbsp;&nbsp;�bersetzung auf spanisch</font></td>
  </tr>
  <tr>
    ...
    <td bgcolor="#f9f9f9"><font face="verdana,arial" size=2>&nbsp;&nbsp;�bersetzung auf polnisch</font></td>
  </tr>
  <tr>
    ...
    <td bgcolor="#f9f9f9"><font face="verdana,arial" size=2>&nbsp;&nbsp;�bersetzung auf tschechisch</font></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#f9f9f9"><font face="verdana,arial" size=2>&nbsp;&nbsp;�bersetzungen auf italianisch</font></td>
  </tr>
  <tr>
  ...
  <tr>
    <td  colspan=2>&nbsp;<br><font face="verdana,arial" size=1 color="#0000ff">Achtung: Diese Liste ist unvollst�ndig. Weitere Credits kommen noch dazu.</font></td>
  </tr>
</table>
