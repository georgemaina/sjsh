...
$LDNewAdmNo="Admission No";
$LDAdmitDate='Admission date';
$LDAdmitTime='Admission time';
$LDCaseNr='Encounter-No.';
$LDFileNr='Hospital file No';
$LDTitle='Occupation';
$LDOccupation='Occupation';
$LDCoPID='Payroll/Student ID';
$LDidno='ID Number';
$LNHIFno='NHIF Number';
...
$LDMemberNumber='Member Number';
$LDDiagnosis='Diagnosis';
$LDRecBy='Referred by';
$LDCon='Consultation';
$LDReg='Registration';
$LDFinanceClass='Financial Plan';
$LDReferals='Referal Method';
$LDTherapy='Therapy';
$LDSpecials='Referrer notes';
$LDSelianPID='Hospital PID';
$LDnextkin='Next of Kin';
$LDkinrelation='Relationship';
$LDnextkin2='Next of Kin2';
$LDkinrelation2='Relationship2';
$LDwarningMsg='This Patient has a pending Invoice';
$LDwarningP1='Invoice No';
$LDwarningP2='Date';
$LDwarningP3='Amount';
...
$LDEntryPrompt='Enter the search keyword. For example: last name, or first name, or date of birth, etc.';
$LDSEARCH='SEARCH';
...
$LDPrescriptionsTxt=$LDESE.' Prescriptions dfdf';
$LDLabtests='Lab Tests';
$LDLabtestsTxt=$LDESE.' Lab Tests';
$LDXraytests='X-ray Test Request';
...
$LDBP='Blood Pressure';
$LDPulse='Pulse Rate';
$LDResprate='Respiratory rate';
$LDTemparature='Temperature';
$LDHtc='HTC';
$LDBMI='BMI';
$LDSPO2='SPO2';
...
//
$LDlabParameter='Lab Test';
$LDlabBatchNr='Batch No';
$LDlabGroup='Test Group';
$LDlabStatus='Test Status';
$LDBillNumber='Bill Number';
$LDBillStatus='Bill Status';
$LDlabItem='ItemID';
$LDlabNotes='Notes';
...
/* 2003-05-17 EL */
$LDEnterPersonSearchKey='Enter search keyword: e.g. PID, file number, first name, surname/Ukoo, or birth date, Village, phone';
...
$LDPlsSelectFinanceClass='Please select Payment Plan';
