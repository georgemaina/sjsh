...
*/
	...
	*/
	 ...
	 */	  
	function Connect($argHostname = "", $argUsername = "", $argPassword = "", $argDatabaseName = "", $forceNew = true) 
	{
	...
	*/
	...
	function Execute($sql,$inputarr=false) 
	{
        ...
        function DB_escape_string($String){
            return mysqli_real_escape_string(htmlspecialchars($String));

        }


        function updateAuditTrail($sql){
            $sql2=$this->mysql_escape_mimic($sql);
                ...
                OR ($SQLArray[0] == 'DELETE')) {
                        $AuditSQL = "INSERT INTO audittrail (transactiondate,
                                ...
                                VALUES('" . Date('Y-m-d H:i:s') . "',
                                    '" . trim($_SESSION['sess_user_name']) . "',
                                    '" . $sql2. "')";
                        //echo $AuditSQL;
                        $this->_Execute($AuditSQL);}
